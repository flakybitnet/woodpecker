...
var Flags = []cli.Flag{
	...
	&cli.IntFlag{
		EnvVars: []string{"WOODPECKER_BACKEND_K8S_SECCTX_USER"},
		Name:    "backend-k8s-secctx-user",
		Usage:   "user under which Pod starts",
	},
	&cli.IntFlag{
		EnvVars: []string{"WOODPECKER_BACKEND_K8S_SECCTX_GROUP"},
		Name:    "backend-k8s-secctx-group",
		Usage:   "group under which Pod starts",
	},
	&cli.IntFlag{
		EnvVars: []string{"WOODPECKER_BACKEND_K8S_SECCTX_FSGROUP"},
