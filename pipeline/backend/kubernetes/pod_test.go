...
func TestPodUserHome(t *testing.T) {
	expected := `
	{
		"metadata": {
			"name": "wp-01he8bebctabr3kgk0qj36d2me-0",
			...
			"containers": [
				{
					...
					"env": [
						...
						{
							"name": "CI_SCRIPT",
							"value": ""
						}
					],
					"resources": {}
				}
