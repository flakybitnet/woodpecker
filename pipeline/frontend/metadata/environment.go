...
func (m *Metadata) Environ() map[string]string {
	...
	setNonEmptyEnvVar(params, "CI_REPO_SCM", "git")
	...
	setNonEmptyEnvVar(params, "CI_REPO_TRUSTED", strconv.FormatBool(repo.Trusted))
	...
	setNonEmptyEnvVar(params, "CI_COMMIT_URL", pipeline.ForgeURL) // TODO: Deprecated, remove in 3.x, why commit url?
	...
	setNonEmptyEnvVar(params, "CI_PIPELINE_FINISHED", strconv.FormatInt(pipeline.Finished, 10))
	setNonEmptyEnvVar(params, "CI_PIPELINE_STATUS", pipeline.Status)
