...
func parsePipeline(forge forge.Forge, store store.Store, currentPipeline *model.Pipeline, user *model.User, repo *model.Repo, configs []*forge_types.FileMeta, envs map[string]string) ([]*stepbuilder.Item, error) {
